...
export const HowItWorks = () => {
  const tabs = [
    {
      title: "Connect & Gamify",
      description:
        "Link your social accounts, e-commerce, and content—then watch Perk automatically turn them into engaging challenges",
      icon: FirstIcon,
      id: "workflow",
    ...
    },
    {
      title: "Reward & Track",
      description:
        "Members earn points for engagement and purchases while you track every interaction in real-time",
      icon: SecondIcon,
      id: "tools",
    ...
    },
    {
      title: "Validate & Grow",
      description:
        "Receipt validation captures in-store purchases while analytics show your program's impact on revenue and retention",
      icon: ThirdIcon,
      id: "deploy",
  ...
  return (
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <SectionHeading className="mt-4">Autopilot in Action</SectionHeading>

        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          From content ingestion to reward fulfillment, Perk automates your loyalty
          program so you can focus on strategy while we handle the execution
        </SubHeading>
        {/* Desktop Tabs */}
