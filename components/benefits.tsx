  ...
  const benefits = [
    {
      ...
      description:
        "Gamify what you already publish—posts, emails, videos—no extra production required",
      icon: <RocketIcon className="text-brand size-6" />,
    },
    {
      title: "Reward Everything",
      description:
        "Members earn for engagement and purchases—online shopping and in-store receipts",
      icon: <RealtimeSyncIcon className="text-brand size-6" />,
    },
    {
      title: "Autopilot Operations",
      description:
        "Platform auto-ingests content and rotates challenges while you focus on strategy",
      icon: <GraphIcon className="text-brand size-6" />,
    },
    {
      title: "Smart Personalization",
      description:
        "Behavior and purchase signals automatically tailor prompts and perks per member",
      icon: <ReuseBrainIcon className="text-brand size-6" />,
    },
    {
      title: "Receipt Validation",
      description:
        "Capture and verify retail purchases with OCR technology and fraud detection",
      icon: <ShieldIcon className="text-brand size-6" />,
    },
    {
      title: "Measurable Results",
      description:
        "Track engagement, purchases, and ROI with clean first-party data and dashboards",
    ...
    <Container className="border-divide relative overflow-hidden border-x px-4 py-20 md:px-8">
      <div className="relative flex flex-col items-center">
        ...
        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          Turn your existing content and commerce into a loyalty engine that runs
          on autopilot while delivering measurable business results
        </SubHeading>
      </div>
