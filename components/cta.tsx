  ...
  return (
    <Container className="border-divide relative flex min-h-60 flex-col items-center justify-center overflow-hidden border-x px-4 py-4 md:min-h-120">
      ...
      <SectionHeading className="relative z-10 text-center lg:text-6xl">
        Ready to Build Your <br /> Loyalty Program?
      </SectionHeading>
      <p className="relative z-10 mt-4 max-w-2xl text-center text-gray-600 dark:text-neutral-400">
      ...
      <div className="relative z-20 mt-6 flex flex-col items-center gap-4 sm:flex-row">
